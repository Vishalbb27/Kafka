package com.appdeveloperblog.ws.emailNotification;
...
public class KafkaConsumerConfiguration {
	...
	ConsumerFactory<String, Object> consumerFactory() {
		...
		config.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, ErrorHandlingDeserializer.class); // Catch
																										// Deserialization
																										// error
	...
	KafkaTemplate<String, Object> kafkaTemplate(ProducerFactory<String, Object> producerFactory) {
		return new KafkaTemplate<>(producerFactory); // used to create producer to send message
	}
